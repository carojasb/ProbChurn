...
*	Modificado	por:	<Camilo Andres Rojas y Cesar Leonardo Trompetero>
*/
...
public class NoobChain {
	...
	public static long tiempoinicial = System.nanoTime();
	...
	public static Boolean isChainValid() {
		...
		System.out.println("Tiempo = " + (tiempofinal-tiempoinicial)/1000000 + " ms");
		return true;
	}
